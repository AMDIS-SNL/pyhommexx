...
# (nlev=30 pyhommexx for the D8 student).
#
# After configure:  cmake --build $BUILD_DIR -j 48 --target theta-l-nlev30
# The resulting exec lands at $BUILD_DIR/test_execs/theta-l-nlev30/theta-l-nlev30 —
# path the jobscript expects.
#
...
BUILD_DIR=$SCRATCH/build-hommexx-nlev30
